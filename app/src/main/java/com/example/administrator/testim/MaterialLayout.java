...
public class MaterialLayout extends RelativeLayout {
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        ...
        mCirclelColor = typedArray.getColor(R.styleable.MaterialLayout_my_color, Color.LTGRAY);
        ...
        mColorAlpha = typedArray.getInteger(R.styleable.MaterialLayout_alphamy, DEFAULT_ALPHA);
