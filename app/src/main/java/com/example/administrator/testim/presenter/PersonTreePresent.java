...
import com.example.administrator.testim.bean.PersonBean;
import com.example.administrator.testim.tree.Node;
...
public class PersonTreePresent extends BasePresenter {
    ...
    public void searchDeptAndUserInfo(String deptId, int requestCode) {
        Observable<List<Node>> observable = SmackApplication.superApi.searchDeptAndUserInfo(deptId)
