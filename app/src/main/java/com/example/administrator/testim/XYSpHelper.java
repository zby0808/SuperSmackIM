...
public class XYSpHelper {


    private static XYSpHelper instance;
    ...
    public static XYSpHelper getInstance(Context context) {
        if (instance == null) {
            synchronized (XYSpHelper.class) {
                if (instance == null)
                    instance = new XYSpHelper(context.getApplicationContext());
                return instance;
            }
        }
        return instance;
    ...
    public XYSpHelper(Context context) {
